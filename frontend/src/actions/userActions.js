...
export const login = (email, password) => async (dispatch) => {
        ...
        try {
            ...
            const { data }  = await axios.post(`https://auwshi.onrender.com/api/v1/login`,{email,password});
...
export const register = (userData) => async (dispatch) => {
    ...
    try {
        ...
        const { data }  = await axios.post(`https://auwshi.onrender.com/api/v1/register`,userData, config);
